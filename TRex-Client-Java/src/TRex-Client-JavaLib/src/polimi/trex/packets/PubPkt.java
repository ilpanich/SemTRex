...
/**
 * A publication packet. It is used by sources to send events to the T-Rex
 * engine.
 */
public class PubPkt implements TRexPkt {
	...
	public PubPkt(int eventType) {
		...
		timeStamp = new Timestamp((int) (System.currentTimeMillis() % Integer.MAX_VALUE));
		attributes = new ArrayList<Attribute>();
	}

	public PubPkt(int eventType, Timestamp timeStamp) {
		this.eventType = eventType;
