...
/**
 * Defines a negation, i.e. a constraint that imposes an event not to happen in
 * a given interval. It is used inside a RulePkt.
 */
public class Negation {
	 ...
	 */
	public Negation(int eventType, int upperId, Timestamp lowerTime) {
