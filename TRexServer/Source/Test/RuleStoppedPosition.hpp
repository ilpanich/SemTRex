...
#ifndef RULEPOSITION_H_
#define RULEPOSITION_H_
 ...
 *
 */
class RuleStoppedPosition: public concept::test::TestRule {
public:

	// Attribute names
	static char ATTR_PHONE[];
	static char ATTR_LATITUDE[];
	static char ATTR_LONGITUDE[];
	static char ATTR_SPEED[];
