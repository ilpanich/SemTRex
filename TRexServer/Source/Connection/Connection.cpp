...
Connection::Connection(boost::asio::io_service& io_service, TRexEngine &tRexEngine, SubscriptionTable &subTable, bool usePingPar)
: strand(io_service),
  socket(io_service),
  ...
  requestHandler(tRexEngine, connectionProxy, subTable)
{ }
